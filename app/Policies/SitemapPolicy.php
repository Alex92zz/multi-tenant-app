...
class SitemapPolicy
{
    ...
    {
        return $user->can('force_delete_sitemap');
    }
    ...
    {
        return $user->can('force_delete_any_sitemap');
    }
    ...
    {
        return $user->can('restore_sitemap');
    }
    ...
    {
        return $user->can('restore_any_sitemap');
    }
    ...
    {
        return $user->can('replicate_sitemap');
    }
    ...
    {
        return $user->can('reorder_sitemap');
    }
