...
<head>
    ...
    <!-- Niche Demos -->
    <link rel="stylesheet" href="{{ asset('demos/seo/seo.css') }}">
...
<body class="stretched">
  ...
  ============================================= -->
                                ...
                                <li class="top-links-item"><a href="#"><img src="demos/seo/images/flags/eng.png"
                                    ...
                                    <ul class="top-links-sub-menu">
                                        <li class="top-links-item"><a href="#"><img
                                                    src="demos/seo/images/flags/fre.png" alt="Lang">French</a></li>
                                        <li class="top-links-item"><a href="#"><img
                                                    src="demos/seo/images/flags/ara.png" alt="Lang">Arabic</a></li>
                                        <li class="top-links-item"><a href="#"><img
                                                    src="demos/seo/images/flags/tha.png" alt="Lang">Thai</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div><!-- .top-links end -->
      ...
      ============================================= -->
                        <ul id="top-social">
                            ...
                            <li><a href="https://instagram.com/semicolonweb" class="h-bg-instagram"
                                            ...
                                            <div class="row">
                                                <a href="demo-seo-optimizations.html"
                                                    ...
                                                    <div class="feature-box">
                                                        <div class="fbox-icon mb-2">
                                                            <img src="demos/seo/images/icons/seo.svg"
                                                ...
                                                <a href="demo-seo-social.html"
                                                    ...
                                                    <div class="feature-box">
                                                        ...
                                                        <div class="fbox-content">
                                                            <h3 class="text-transform-none ls-0">Social Media Marketing
                                                            </h3>
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                                Commodi, ipsa!</p>
                                                        </div>
                                                ...
                                                <a href="demo-seo-experience.html"
                                                    ...
                                                    <div class="feature-box">
                                                        ...
                                                        <div class="fbox-content">
                                                            <h3 class="text-transform-none ls-0">Customer Experience
                                                            </h3>
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                                Commodi, ipsa!</p>
                                                        </div>
                                                ...
                                                <div class="mega-menu-column sub-menu-container col-12 p-0">
                                                    <a href="demo-seo-about.html"
                                                        class="button button-rounded button-large text-transform-none ls-0 w-100 text-center m-0 rounded-0 py-3 button-light ">View
                                                        All <i class="bi-arrow-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
  ...
  ============================================= -->
        <section id="slider" class="slider-element slider-parallax min-vh-60 min-vh-md-100 include-header">
            <div class="slider-inner"
                style="background: var(--cnvs-contrast-0) url('demos/seo/images/hero/hero-1.jpg') center center no-repeat; background-size: cover;">
                        ...
                        <div class="row pt-5">
                            <div class="col-lg-5 col-md-8">
                                <div class="slider-title">
                                    ...
                                    <h3 class="text-rotater mb-2" data-separator="," data-rotate="fadeIn"
                                        data-speed="3500">- Boost your own <span
                                            class="t-rotate">Awesome,Beautiful,Great</span> Website.</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quia vitae mollitia
                                        dignissimos ab qui aspernatur.</p>
                                    <a href="demo-seo-about.html"
                                        class="button button-rounded button-large text-transform-none ls-0">Get
                                        Started</a>
                ...
                <div class="section bg-transparent m-0 border-bottom py-5">
                    <div class="container">
                        <div id="oc-clients" class="owl-carousel image-carousel carousel-widget" data-margin="100"
                            data-loop="true" data-autoplay="5000" data-nav="false" data-pagi="false"
                            data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5"
                            data-items-xl="6">
                            <div class="oc-item"><a href="#"><img
                                        src="demos/business/images/clients/linkedin.svg" alt="Brands"></a></div>
                            <div class="oc-item"><a href="#"><img
                                        src="demos/business/images/clients/nat-geo.svg" alt="Brands"></a></div>
                            <div class="oc-item"><a href="#"><img
                                        src="demos/business/images/clients/jetblue.svg" alt="Brands"></a></div>
                            <div class="oc-item"><a href="#"><img
                                        src="demos/business/images/clients/zillow.svg" alt="Brands"></a></div>
                            <div class="oc-item"><a href="#"><img
                                        src="demos/business/images/clients/amazon.svg" alt="Brands"></a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section bg-transparent mt-4 mb-0 pb-0">
                    <div class="container">
                        <div class="heading-block border-bottom-0 text-center mx-auto mb-0" style="max-width: 550px">
                            ...
                            <p>Dynamically provide access to resource-leveling mindshare vis-a-vis bricks-and-clicks
                                ideas authoritatively.</p>
                        </div>
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="feature-box flex-md-row-reverse text-md-end border-0">
                                    <div class="fbox-icon">
                                        <a href="#"><img src="demos/seo/images/icons/seo.svg"
                                ...
                                <div class="feature-box flex-md-row-reverse text-md-end border-0 mt-5">
                                    <div class="fbox-icon">
                                        <a href="#"><img src="demos/seo/images/icons/adword.svg"
                                                alt="Feature Icon" class="bg-transparent rounded-0"></a>
                                    </div>
                                    <div class="fbox-content">
                                        <h3 class="text-transform-none ls-0">Adwords Campaign</h3>
                                ...
                                <div class="feature-box flex-md-row-reverse text-md-end border-0 mt-5">
                                    <div class="fbox-icon">
                                        <a href="#"><img src="demos/seo/images/icons/analysis.svg"
                                                alt="Feature Icon" class="bg-transparent rounded-0"></a>
                                    </div>
                                    <div class="fbox-content">
                                        <h3 class="text-transform-none ls-0">Digital Analysis</h3>
                            ...
                            <div class="col-lg-3 col-7 offset-3 offset-sm-0 d-sm-none d-lg-block text-center my-5">
                                <img src="demos/seo/images/sections/2.png" alt="iphone" class="rounded parallax"
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="feature-box border-0">
                                    <div class="fbox-icon">
                                        <a href="#"><img src="demos/seo/images/icons/social.svg"
                                                alt="Feature Icon" class="bg-transparent rounded-0"></a>
                                    </div>
                                    <div class="fbox-content">
                                ...
                                <div class="feature-box border-0 mt-5">
                                    <div class="fbox-icon">
                                        <a href="#"><img src="demos/seo/images/icons/experience.svg"
                                                alt="Feature Icon" class="bg-transparent rounded-0"></a>
                                    </div>
                                    <div class="fbox-content">
                                ...
                                <div class="feature-box border-0 mt-5">
                                    <div class="fbox-icon">
                                        <a href="#"><img src="demos/seo/images/icons/content_marketing.svg"
                                                alt="Feature Icon" class="bg-transparent rounded-0"></a>
                                    </div>
                                    <div class="fbox-content">
                                        <h3 class="text-transform-none ls-0">Content Marketing</h3>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-lg-4 mt-4">
                                <div class="heading-block border-bottom-0 mb-4">
                                    ...
                                    <h3 class="text-transform-none ls-0">No Hidden Charges. <br>Choose Your Best Plan.
                                    </h3>
                                </div>
                                    ...
                                    <div id="pricing-switch" class="pricing row align-items-end g-0 col-mb-50 mb-4">
                                            ...
                                            <div class="pricing-box">
                                                <div class="pricing-title">
                                                    <img class="mb-2 bg-transparent rounded-0"
                                                        src="demos/seo/images/icons/man.svg" alt="Pricing Icon"
                                                        width="50">
                                                ...
                                                <div class="pricing-features border-0 bg-transparent">
                                                    <ul>
                                                        ...
                                                        <li><i
                                                            ...
                                                            User License</li>
                                                        <li><i class="fa-solid fa-check-circle color me-2"></i>Phone
                                                            &amp; Email Support</li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="pricing-box">
                                                <div class="pricing-title">
                                                    <img class="mb-2 bg-transparent rounded-0"
                                                        src="demos/seo/images/icons/group.svg" alt="Pricing Icon"
                                                        width="60">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-widget">
                                            ...
                                            <form class="row mb-0" id="template-contactform"
                                                name="template-contactform" action="include/form.php" method="post">
                                                ...
                                                <div class="col-12 form-group mb-0">
                                                    <button
                                                        class="button button-rounded w-100 text-transform-none ls-0 m-0"
                                                        type="submit" id="template-contactform-submit"
                                                        name="template-contactform-submit" value="submit">Apply
                                                        Now</button>
                                                </div>
                ...
                <div class="section m-0"
                    ...
                    <div class="container">
                        ...
                        <div class="text-center">
                            <a href="demo-seo-about.html"
                                class="button button-large button-rounded text-capitalize ms-0 mt-5 ls-0">View All
                                Works</a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mt-5">
                            <div class="feature-box fbox-center border-0">
                                <div class="fbox-icon">
                                    <a href="#"><img src="demos/seo/images/icons/research.svg"
                                            alt="Feature Icon" class="bg-transparent rounded-0"></a>
                                </div>
                                <div class="fbox-content">
                        ...
                        <div class="col-md-4 mt-5">
                            <div class="feature-box fbox-center border-0">
                                <div class="fbox-icon">
                                    <a href="#"><img src="demos/seo/images/icons/optimizing.svg"
                                            alt="Feature Icon" class="bg-transparent rounded-0"></a>
                                </div>
                                <div class="fbox-content">
                ...
                <div class="section mt-0"
                    ...
                    <div class="container">
                        ...
                        <div id="oc-testi" class="owl-carousel testimonials-carousel carousel-widget"
                            data-margin="0" data-pagi="true" data-loop="true" data-center="true"
                            data-autoplay="5000" data-items-xs="1" data-items-sm="1" data-items-md="2"
                            data-items-xl="3">

                            <div class="oc-item">
                                <div class="card rounded-6 shadow border-0">
                                    <img class="testimonial-image rounded-circle p-2 bg-white"
                                        src="demos/pet/images/testimonials/1.jpg" alt="Customer Testimonails">
                                    <div class="card-body p-4 pt-2 position-relative overflow-hidden">
                                        <div class="row">
                                            <div class="col-12 text-center">
                                                <p class="mb-4 font-primary fst-normal">Incidunt deleniti blanditiis
                                                    quas aperiam recusandae consequatur ullam quibusdam cum libero illo
                                                    rerum repellendus!</p>
                            ...
                            <div class="oc-item">
                                <div class="card rounded-6 shadow border-0">
                                    <img class="testimonial-image rounded-circle p-2 bg-white"
                                        src="demos/pet/images/testimonials/2.jpg" alt="Customer Testimonails">
                                    <div class="card-body p-4 pt-2 position-relative overflow-hidden">
                                        <div class="row">
                                            <div class="col-12 text-center">
                                                <p class="mb-4 font-primary fst-normal">Natus voluptatum enim quod
                                                    necessitatibus quis expedita harum provident eos obcaecati id culpa
                            ...
                            <div class="oc-item">
                                <div class="card rounded-6 shadow border-0">
                                    <img class="testimonial-image rounded-circle p-2 bg-white"
                                        src="demos/pet/images/testimonials/3.jpg" alt="Customer Testimonails">
                                    <div class="card-body p-4 pt-2 position-relative overflow-hidden">
                                        <div class="row">
                                            <div class="col-12 text-center">
                                                <p class="mb-4 font-primary fst-normal">Natus voluptatum enim quod
                            ...
                            <div class="oc-item">
                                <div class="card rounded-6 shadow border-0">
                                    <img class="testimonial-image rounded-circle p-2 bg-white"
                                        src="demos/pet/images/testimonials/4.jpg" alt="Customer Testimonails">
                                    <div class="card-body p-4 pt-2 position-relative overflow-hidden">
                                        <div class="row">
                                            <div class="col-12 text-center">
                                                <p class="mb-4 font-primary fst-normal">Natus voluptatum enim quod
                            ...
                            <div class="oc-item">
                                <div class="card rounded-6 shadow border-0">
                                    <img class="testimonial-image rounded-circle p-2 bg-white"
                                        src="images/testimonials/5.jpg" alt="Customer Testimonails">
                                    <div class="card-body p-4 pt-2 position-relative overflow-hidden">
                                        <div class="row">
                                            <div class="col-12 text-center">
                                                <p class="mb-4 font-primary fst-normal">Natus voluptatum enim quod
                ...
                <div class="section mt-5 footer-stick promo-section bg-transparent"
                    ...
                    <div class="container">
                        <div class="heading-block border-bottom-0 text-center">
                            ...
                            <h2 class="text-transform-none ls-0">Try Keyword Search 30 Days Free With
                                Canvas<span>SEO</span></h2>
                            <a href="demo-seo-contact.html"
                                class="button button-large button-rounded text-transform-none ms-0 ls-0 mt-4">Contact
                                Us Now</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row col-mb-50">
                        <div class="col-md-8">
                            ...
                            <div class="widget">
                                ...
                                <img src="images/footer-widget-logo.png" alt="Footer Logo" class="alignleft"
                            ...
                            <div class="widget subscribe-widget">
                                ...
                                <form id="widget-subscribe-form" action="include/subscribe.php" method="post"
                                    ...
                                    <div class="input-group mx-auto">
                                        ...
                                        <button
                                            class="btn btn-success button button-color text-transform-none ls-0 m-0"
                                ...
                                <div class="row col-mb-30">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-6">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="https://themeforest.net/user/SemiColonWeb/follow" target="_blank"
                                                class="text-dark"><small><strong class="d-block">Subscribe</strong>to
                                                    RSS Feeds</small></a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-between col-mb-30">
                        <div class="col-12 col-lg-auto text-center text-lg-start">
                            ...
                            <div class="copyright-links"><a href="#" class="text-contrast-600">Terms of Use</a>
                                / <a href="#" class="text-contrast-600">Privacy Policy</a></div>
                        </div>

                        <div class="col-12 col-lg-auto text-center text-lg-end">
                            <div class="copyrights-menu copyright-links">
                                <a href="#" class="text-contrast-600">Home</a>/<a href="#"
                                    class="text-contrast-600">About Us</a>/<a href="#"
                                    class="text-contrast-600">Team</a>/<a href="#"
                                    class="text-contrast-600">Clients</a>/<a href="#"
                                    class="text-contrast-600">FAQs</a>/<a href="#"
                                    class="text-contrast-600">Contact</a>
                            </div>
                        </div>
                    </div>
 ...
 ============================================= -->
    ...
    <!-- Parallax Script
 ============================================= -->
    <script src="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/skrollr/0.6.30/skrollr.min.js') }}"></script>
    <script>
