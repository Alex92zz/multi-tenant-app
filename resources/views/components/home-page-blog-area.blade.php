...
<section class="blog-list-half crev section-padding">
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <h2 class="d-rotate wow">
                        <span class="rotate-text">Latest Posts.</span>
                    </h2>
                </div>
                <div class="col-lg-6 d-flex align-items-center">
                    <div class="full-width d-flex justify-content-end justify-end">
                        <div class="vew-all">
                            <a href="blog-list.html">View All Our Posts
                                <span>
        ...
        <div class="row wow fadeIn" data-wow-delay=".4s">
                ...
                @foreach ($recentPosts->take(2) as $recentPost)
                <div class="col-lg-6">
                    <div class="item md-mb80">
                        <div class="row rest">
                            ...
                            <div class="col-md-6 valign">
                                <div class="cont">
                                    <span
                                        class="date fz-12 ls1 text-u opacity-7 mb-15">{{ date('d F Y', strtotime($recentPost->created_at)) }}</span>
                                    <h5>
                                        <a
                                            href="{{ route('posts.show', ['slug' => $recentPost->slug]) }}">{{ $recentPost->title }}</a>
                                    </h5>
