...
<head>
    ...
    <meta charset="utf-8">
    <meta name="csrf-token" content="0fpSdtSQAlW6Y0yAjcJgu9mHWN9gb3PwrDj4R3l6">
    ...
    <link href="{{ asset('css/filament/forms/forms.css?v=3.0.0.0') }}" rel="stylesheet" data-navigate-track="">
    <link href="{{ asset('css/filament/support/support.css?v=3.0.0.0') }}" rel="stylesheet" data-navigate-track="">
    ...
    <link href="{{ asset('css/filament/filament/app.css?v=3.0.0.0') }}" rel="stylesheet" data-navigate-track="">
...
<body class="min-h-screen bg-gray-50 font-normal text-gray-950 antialiased dark:bg-gray-950 dark:text-white">
    ...
    @csrf
                                ...
                                <div style="--col-span-default: span 1 / span 1;" class="col-[--col-span-default]"
                                    ...
                                    <div class="fi-fo-field-wrp">
                                        ...
                                        <div class="grid gap-y-2">
                                            ...
                                            <div class="grid gap-y-2">
                                                <div
                                                    class="fi-input-wrapper flex rounded-lg shadow-sm ring-1 transition duration-75 bg-white focus-within:ring-2 dark:bg-white/5 ring-gray-950/10 focus-within:ring-primary-600 dark:ring-white/20 dark:focus-within:ring-primary-500 fi-fo-text-input overflow-hidden">
                                                    ...
                                                    <div class="min-w-0 flex-1">
                                                        <input
                                                         ...
                                                         autofocus="autofocus" id="name" name="name"
                                            ...
                                            <div class="grid gap-y-2">
                                                <div
                                                    ...
                                                    <div class="min-w-0 flex-1">
                                                        <input
                                                            class="fi-input block w-full border-none bg-transparent py-1.5 text-base text-gray-950 outline-none transition duration-75 placeholder:text-gray-400 focus:ring-0 disabled:text-gray-500 disabled:[-webkit-text-fill-color:theme(colors.gray.500)] disabled:placeholder:[-webkit-text-fill-color:theme(colors.gray.400)] dark:text-white dark:placeholder:text-gray-500 dark:disabled:text-gray-400 dark:disabled:[-webkit-text-fill-color:theme(colors.gray.400)] dark:disabled:placeholder:[-webkit-text-fill-color:theme(colors.gray.500)] sm:text-sm sm:leading-6 ps-3 pe-3"
                                                            id="password" name="password" required="required" type="password"
                                                           >
                                                    </div>
                                            ...
                                            <div class="grid gap-y-2">
                                                <div
                                                    ...
                                                    <div class="min-w-0 flex-1">
                                                        <input
                                                            class="fi-input block w-full border-none bg-transparent py-1.5 text-base text-gray-950 outline-none transition duration-75 placeholder:text-gray-400 focus:ring-0 disabled:text-gray-500 disabled:[-webkit-text-fill-color:theme(colors.gray.500)] disabled:placeholder:[-webkit-text-fill-color:theme(colors.gray.400)] dark:text-white dark:placeholder:text-gray-500 dark:disabled:text-gray-400 dark:disabled:[-webkit-text-fill-color:theme(colors.gray.400)] dark:disabled:placeholder:[-webkit-text-fill-color:theme(colors.gray.500)] sm:text-sm sm:leading-6 ps-3 pe-3"
                                                            id="confirm_password" name="confirm_password" required="required" type="password"
                                                            >
                                                    </div>
                                            ...
                                            <div class="grid gap-y-2">
                                                <div
                                                    ...
                                                    <div class="min-w-0 flex-1">
                                                        <input
                                                            class="fi-input block w-full border-none bg-transparent py-1.5 text-base text-gray-950 outline-none transition duration-75 placeholder:text-gray-400 focus:ring-0 disabled:text-gray-500 disabled:[-webkit-text-fill-color:theme(colors.gray.500)] disabled:placeholder:[-webkit-text-fill-color:theme(colors.gray.400)] dark:text-white dark:placeholder:text-gray-500 dark:disabled:text-gray-400 dark:disabled:[-webkit-text-fill-color:theme(colors.gray.400)] dark:disabled:placeholder:[-webkit-text-fill-color:theme(colors.gray.500)] sm:text-sm sm:leading-6 ps-3 pe-3"
                                                         autofocus="autofocus" name="secret_code" id="secret_code"
                                                            required="required" type="text">
                                                    </div>
                            ...
                            <div>
                                <div
                                    class="fi-ac gap-3 grid grid-cols-[repeat(auto-fit,minmax(0,1fr))] fi-form-actions">
                                    <button 
                                        ...
                                        <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                            class="animate-spin fi-btn-icon h-5 w-5  md" wire:loading.delay=""
                                        ...
                                        <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                            class="animate-spin fi-btn-icon h-5 w-5  md" x-show="isUploadingFile"
                                            style="display: none;">
                                            <path clip-rule="evenodd"
                                                d="M12 19C15.866 19 19 15.866 19 12C19 8.13401 15.866 5 12 5C8.13401 5 5 8.13401 5 12C5 15.866 8.13401 19 12 19ZM12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z"
                                                fill-rule="evenodd" fill="currentColor" opacity="0.2"></path>
    ...
    <div wire:snapshot="{&quot;data&quot;:{&quot;isFilamentNotificationsComponent&quot;:true,&quot;notifications&quot;:[[],{&quot;class&quot;:&quot;Filament\\Notifications\\Collection&quot;,&quot;s&quot;:&quot;wrbl&quot;}]},&quot;memo&quot;:{&quot;id&quot;:&quot;PudwCtXeEUJUu1MdDKOy&quot;,&quot;name&quot;:&quot;filament.livewire.notifications&quot;,&quot;path&quot;:&quot;admin\/login&quot;,&quot;method&quot;:&quot;GET&quot;,&quot;children&quot;:[],&quot;errors&quot;:[],&quot;locale&quot;:&quot;en&quot;},&quot;checksum&quot;:&quot;16bb76268dcac0975f964385690b5285b6acc51fe498186f565df652be7ee121&quot;}"
        wire:effects="{&quot;listeners&quot;:[&quot;notificationsSent&quot;,&quot;notificationSent&quot;,&quot;notificationClosed&quot;]}"
        wire:id="PudwCtXeEUJUu1MdDKOy">
        <div class="fi-no pointer-events-none fixed inset-4 z-50 mx-auto flex gap-3 items-end flex-col-reverse justify-end"
            role="status">
        </div>
    ...
    <script src="{{ asset('js/filament/forms/forms.js?v=3.0.0.0') }}" data-navigate-track=""></script>
    <script src="{{ asset('js/filament/notifications/notifications.js?v=3.0.0.0') }}" data-navigate-track=""></script>
    <script src="{{ asset('js/filament/support/async-alpine.js?v=3.0.0.0') }}" data-navigate-track=""></script>
    <script src="{{ asset('js/filament/support/support.js?v=3.0.0.0') }}" data-navigate-track=""></script>
    <script src="{{ asset('js/filament/tables/tables.js?v=3.0.0.0') }}" data-navigate-track=""></script>
    <script src="{{ asset('js/filament/filament/echo.js?v=3.0.0.0') }}" data-navigate-track=""></script>
    <script src="{{ asset('js/filament/filament/app.js?v=3.0.0.0') }}" data-navigate-track=""></script>
    ...
    <!-- Livewire Scripts -->
    <script src="/livewire/livewire.js?id=2f6e5d4d" data-csrf="0fpSdtSQAlW6Y0yAjcJgu9mHWN9gb3PwrDj4R3l6"
